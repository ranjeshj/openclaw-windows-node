...
/// place), the WSL distro name the gateway-compat test harness uses, and
/// tiny MCP result-unwrapping helpers.
/// </summary>
internal static class GatewayCompatScenarios
{
    /// <summary>
    /// Distro name used by tools/gateway-compat/Ensure-TestGateway.ps1.
    /// Intentionally DIFFERENT from the production tray's default
    /// "OpenClawGateway" so dev machines can run both side by side.
    /// </summary>
    public const string DistroName = "OpenClawGatewayCompat";
